			...
			<div class="table">
				<div class="table-cell">
					<div class="pv-hover">
						<a href="#">
							<div class="square">
								<div class="link-box"><i class="fa fa-link fa-2x"></i></div>
								<p class="hover-firma" >TSV Mühlhausen</p>
								<p class="hover-branche" >Vereinsseite</p>
								<svg version="1.1" class="hover-icon hover-drop" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		<section class="kontakt">
			...
			<script>	
				$(document).ready(function() {
				    $(".item").hover(function () {
				        $(this).find(".pv-hover").fadeToggle(800);
				    })
				})
			</script>
	</div>
